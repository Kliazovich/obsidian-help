...
- Sync enabled within the [[Базавыя плагіны]] settings. 
...
>
> If you want to sync vault configuration, such as settings for [[Базавыя плагіны]], [[Hotkeys]], or [[Плагіны супольнасці]], learn how to [[Select files and settings to sync#Sync vault configuration|Sync vault configuration]].
