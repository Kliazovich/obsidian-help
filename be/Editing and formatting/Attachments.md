...
> If you drag a file from your file system into an open editor, Obsidian copies the file to the default attachment location and [[Embed files|embeds]] it in the note.
 ...
 > You can download an attachment directly to your vault, for example if you  [[Імпарт нататак#Import from browser|import from your browser]], or from other apps that saves files directly to your file system.
